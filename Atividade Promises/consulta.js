document.addEventListener('DOMContentLoaded', ()=>{
    ...
    consultaCep.addEventListener('click',async ()=>{
        ...
        console.log(cep)
        try{
            const response = await fetch(`https://api.allorigins.win/raw?url=https://viacep.com.br/ws/${cep}/json/`);
            
            if(!response.ok){
                erro.innerHTML = '*Ocorreu algum erro na consulta, ou o CEP nao existe.'
